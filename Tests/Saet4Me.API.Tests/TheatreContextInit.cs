    ...
    public static class TheatreContextInit
    {
        ...
        public static void AddTestData(TheatreContext context)
        {
            ...
            context.Shows.Add(new Show()
            {
                ...
                Description = "Guy Cassiers, Tom Lanoye en het stuk der stukken: Shakespeares Hamlet. Cassiers regisseerde deze bewerking met een grote cast, samengesteld uit de ensembles van Toneelhuis en Toneelgroep Amsterdam.",
                RegularPrice = 27.50M,
